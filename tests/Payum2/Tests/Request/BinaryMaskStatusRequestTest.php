...
class BinaryMaskStatusRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Request\BinaryMaskStatusRequest');

        $this->assertTrue($rc->implementsInterface('Payum2\Request\StatusRequestInterface'));
    }
    ...
    public function shouldBeSubClassOfBaseModelInteractiveRequest()
    {
        ...
        $this->assertTrue($rc->isSubclassOf('Payum2\Request\BaseModelInteractiveRequest'));
    }
