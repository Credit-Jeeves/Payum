...
class BaseModelRequestTest extends \PHPUnit_Framework_TestCase 
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Request\BaseModelRequest');
    ...
    {
        $this->getMockForAbstractClass('Payum2\Request\BaseModelRequest', array($phpType));
    }
    ...
    {
        $request = $this->getMockForAbstractClass('Payum2\Request\BaseModelRequest', array(123321));
    ...
    {
        $request = $this->getMockForAbstractClass('Payum2\Request\BaseModelRequest', array($phpType));
    ...
    public function shouldConvertArrayToArrayObjectInConstructor()
    {
        ...
        $request = $this->getMockForAbstractClass('Payum2\Request\BaseModelRequest', array($model));
