...
class HttpExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Exception\Http\HttpException');
        
        $this->assertTrue($rc->isSubclassOf('Payum2\Exception\RuntimeException'));
    }
    ...
    public function shouldImplementHttpExceptionInterface()
    {
        ...
        $this->assertTrue($rc->isSubclassOf('Payum2\Exception\Http\HttpExceptionInterface'));
    }
    ...
    public function shouldAllowFactoryHttpExceptionFromRequestAndResponse()
    {
        ...
        $this->assertInstanceOf('Payum2\Exception\Http\HttpException', $httpException);
