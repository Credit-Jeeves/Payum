...
class ExtensionCollectionTest extends \PHPUnit_Framework_TestCase 
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Extension\ExtensionCollection');
    ...
    {
        $expectedRequest = new \stdClass;
        $expectedAction = $this->getMock('Payum2\Action\ActionInterface');
    ...
    {
        $expectedInteractiveRequest = $this->getMock('Payum2\Request\InteractiveRequestInterface');
        $expectedAction = $this->getMock('Payum2\Action\ActionInterface');
        $expectedRequest = new \stdClass;
    ...
    {
        $expectedInteractiveRequest = $this->getMock('Payum2\Request\InteractiveRequestInterface');
        $expectedNewInteractiveRequest = $this->getMock('Payum2\Request\InteractiveRequestInterface');
        $expectedAction = $this->getMock('Payum2\Action\ActionInterface');
        $expectedRequest = new \stdClass;
