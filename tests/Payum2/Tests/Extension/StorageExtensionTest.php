<?php
namespace Payum2\Tests\Extension;

use Payum2\Extension\StorageExtension;
use Payum2\Storage\Identificator;
...
class StorageExtensionTest extends \PHPUnit_Framework_TestCase 
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Extension\StorageExtension');

        $this->assertTrue($rc->implementsInterface('Payum2\Extension\ExtensionInterface'));
    }
    ...
    public function shouldDoNothingOnPreExecuteIfStorageNotSupportModel()
    {
        ...
        $modelRequestMock = $this->getMock('Payum2\Request\ModelRequestInterface');
        $modelRequestMock
            ->expects($this->any())
            ->method('getModel')
    ...
    public function shouldDoNothingOnPreExecuteIfRequestNotModelRequest()
    {
        ...
        $notModelRequestMock = $this->getMock('Payum2\Request\RequestInterface');
    ...
    {
        $modelRequestMock = $this->getMock('Payum2\Request\ModelRequestInterface', array('setModel', 'getModel'));
        $modelRequestMock
            ->expects($this->any())
            ->method('getModel')
    ...
    {
        return $this->getMock('Payum2\Storage\StorageInterface');
    }
    ...
    {
        return $this->getMock('Payum2\Request\InteractiveRequestInterface');
    }
}