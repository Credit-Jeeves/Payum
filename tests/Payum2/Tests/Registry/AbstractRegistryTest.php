...
class AbstractRegistryTest extends \PHPUnit_Framework_TestCase 
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Registry\AbstractRegistry');

        $this->assertTrue($rc->implementsInterface('Payum2\Registry\PaymentRegistryInterface'));
    }
    ...
    public function shouldImplementStorageRegistryInterface()
    {
        ...
        $this->assertTrue($rc->implementsInterface('Payum2\Registry\StorageRegistryInterface'));
    }
    ...
    {
        $registryMock = $this->getMockForAbstractClass('Payum2\Registry\AbstractRegistry', $constructorArguments);
