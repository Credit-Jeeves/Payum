...
class PaymentTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Payment');
        
        $this->assertTrue($rc->implementsInterface('Payum2\PaymentInterface'));
    }
    ...
    public function shouldCreateExtensionCollectionInstanceInConstructor()
    {
        ...
        $this->assertAttributeInstanceOf('Payum2\Extension\ExtensionCollection', 'extensions', $payment);
    }
    ...
    public function shouldSetFirstApiToActionApiAware()
    {
        ...
        $action = $this->getMockForAbstractClass('Payum2\Tests\ApiAwareAction');
        $action
            ->expects($this->once())
            ->method('setApi')
     ...
     * @test
     * 
     * @expectedException \Payum2\Request\BaseInteractiveRequest
     */
    ...
    public function shouldSetPaymentToActionIfActionAwareOfPayment()
    {
        ...
        $actionMock = $this->getMock('Payum2\Action\PaymentAwareAction');
        $actionMock
            ->expects($this->once())
            ->method('setPayment')
    ...
    public function shouldCallExtensionOnExceptionWhenExceptionThrown()
    {
        ...
        $extensionMock
            ...
            ->method('onException')
            ->with(
                $this->isInstanceOf('Payum2\Exception\RequestNotSupportedException'),
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\Payum2\Request\InteractiveRequestInterface
     */
    protected function createInteractiveRequestMock()
    {
        return $this->getMock('Payum2\Request\BaseInteractiveRequest');
    }

    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\Payum2\Extension\ExtensionInterface
     */
    protected function createExtensionMock()
    {
        return $this->getMock('Payum2\Extension\ExtensionInterface');
    }
